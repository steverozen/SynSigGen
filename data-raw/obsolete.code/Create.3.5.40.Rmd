...
```{r}
top.level.dir<- "tmp.syn.3.5.40.rcc.and.ovary"
SetNewOutDir(top.level.dir)
```
...
```{r}
Diff4SynDataSets("syn.3.5.40.rcc.and.ovary", unlink = FALSE)
